...
extension ForEach where Content: View {
    public init(_ data: Data, id: Swift.KeyPath<Data.Element, ID>, content: @escaping (Data.Element) -> Content) { fatalError() }
}
extension ForEach where Data == Swift.Range<Swift.Int>, ID == Swift.Int, Content: View {
    public init(_ data: Swift.Range<Swift.Int>, @ViewBuilder content: @escaping (Swift.Int) -> Content) { fatalError() }
}
