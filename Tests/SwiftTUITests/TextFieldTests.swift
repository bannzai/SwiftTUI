...
final class TextFieldTests: SwiftTUITestCase {
  ...
  func testTextFieldWithInitialText() {
    ...
    XCTAssertFalse(
      output.contains("Placeholder"), "Placeholder should not be visible when text exists")
  }
  ...
  func testPlaceholderVisibility() {
    ...
    // Then
    XCTAssertTrue(
      emptyOutput.contains("Empty placeholder"), "Placeholder should show when text is empty")
    XCTAssertFalse(
      filledOutput.contains("Filled placeholder"), "Placeholder should not show when text exists")
    XCTAssertTrue(
      filledOutput.contains("Content"), "Actual text should show instead of placeholder")
  }
  ...
  func testLongPlaceholder() {
    ...
    // Then
    XCTAssertTrue(
      output.contains("This is a very long placeholder text"),
      "Long placeholder should be displayed")
  }
