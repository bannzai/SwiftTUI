...
final class PickerTests: SwiftTUITestCase {
  ...
  func testPickerInitialSelection() {
    ...
    let colorPicker = Picker(
      "Color", selection: .constant("Green"), options: ["Red", "Green", "Blue"])
  ...
  func testPickerMultipleOptions() {
    ...
    let picker = Picker(
      "Language", selection: .constant("Swift"),
  ...
  func testPickerBinding() {
    ...
    let picker = Picker(
      "Option", selection: .constant("Beta"), options: ["Alpha", "Beta", "Gamma"])
  ...
  func testPickerSelectionReflection() {
    ...
    let picker = Picker(
      "Fruit", selection: .constant("Apple"), options: ["Apple", "Banana", "Orange"])
  ...
  func testPickerMultipleBindings() {
    ...
    let themePicker = Picker(
      "Theme", selection: .constant("Dark"), options: ["Light", "Dark", "Auto"])
  ...
  func testPickerBindingTypes() {
    ...
    let stringPicker = Picker(
      "String", selection: .constant("Option2"), options: ["Option1", "Option2", "Option3"])
  ...
  func testPickerFocusDisplay() {
    ...
    let picker = Picker(
      "Focusable", selection: .constant("Default"), options: ["Default", "Other"])
  ...
  func testPickerLongLabels() {
    ...
    let picker = Picker(
      "This is a very long picker label",
  ...
  func testPickerSpecialCharacters() {
    ...
    let specialPicker = Picker(
      "Special [Chars]", selection: .constant("Option (1)"),
    ...
    XCTAssertTrue(
      specialOutput.contains("Special [Chars]"), "Should show special characters in label")
